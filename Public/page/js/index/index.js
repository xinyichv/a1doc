...
function createInstructions() {
	...
	text.innerHTML = '<span style="color:' + theme[0] + ';font-size:40px;">您好!</span><br /><br /><span style="font-size:15px;"><strong>欢迎来到A1-DOC的世界</strong><br /><br />你可以利用它编写文档分享你的知识<br />点击右上角进入体验<br />或者点击或拖动小球玩耍一阵<br />加入我们<br />带你一起飞翔!</span>';
