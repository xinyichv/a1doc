				...
				<ul class="nav ace-nav">
					...
					<li class="light-blue">
						...
						<ul class="user-menu dropdown-menu-right dropdown-menu dropdown-yellow dropdown-caret dropdown-close">
							<li>
								<a href="<?php echo U('Home/User/setting');?>">
							...
							<li class="divider"></li>
							<li>
								<a href="<?php echo U('Home/User/exist');?>">
		...
		<div class="main-content">
			<div class="main-content-inner">
				<div class="page-content">
					<div class="row">
						<!-- PAGE CONTENT BEGINS -->
						<?php if(is_array($items)): foreach($items as $key=>$item): ?><div class="col-xs-2">
					        	<a class="thumbnail alert-info a1thumbnail" href="show?item_id=<?php echo ($item["item_id"]); ?>" title="<?php echo ($item["item_description"]); ?>">
					        		<p><?php echo ($item["item_name"]); ?></p>
					        	</a>
					        </div><?php endforeach; endif; ?>
				        <div class="col-xs-2">
							<a class="thumbnail alert-info a1thumbnail" href="<?php echo U('Home/Item/add');?>" title="添加一个新项目">
				        		<p>
				        			新建项目
